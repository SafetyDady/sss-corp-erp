...
export default function CustomerFormModal({ open, editItem, onClose, onSuccess }) {
  ...
  const onFinish = async (values) => {
    ...
    try {
      if (editItem) {
        await api.put(`/api/customers/${editItem.id}`, values);
      } else {
  ...
  return (
    <Modal
      title={editItem ? '\u0E41\u0E01\u0E49\u0E44\u0E02\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32' : '\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32'}
      open={open}
      onCancel={onClose}
      onOk={() => form.submit()}
    ...
    >
      <Form form={form} layout="vertical" onFinish={onFinish}>
        ...
        <Form.Item name="name" label={'\u0E0A\u0E37\u0E48\u0E2D\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32'}
