...
export default function LocationListPage({ embedded = false }) {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const { data } = await api.get('/api/warehouse/locations', {
        params: {
  ...
  const columns = [
    ...
    { title: '\u0E0A\u0E37\u0E48\u0E2D\u0E15\u0E33\u0E41\u0E2B\u0E19\u0E48\u0E07', dataIndex: 'name', key: 'name' },
    { title: 'Zone Type', dataIndex: 'zone_type', key: 'zone_type', width: 120 },
    {
      title: '\u0E04\u0E25\u0E31\u0E07', dataIndex: 'warehouse_id', key: 'warehouse_id',
